...
class WR_Contactform_Helpers_Contactform {
	...
	public static function get_translated( $strings ) {
		...
		foreach ( $strings AS $string ) {
			$translated[ strtoupper( $string ) ] = str_replace( "'", '&apos;', __( $string, WR_CONTACTFORM_TEXTDOMAIN ) );
		}
	...
	public static function generate_html_pages( $postId, $formId, $formName, $formType = '', $topContent = '', $bottomContent = '', $showTitle = false, $showDes = false ) {
		...
		$arrayTranslated = array(
			'WR_CONTACTFORM_CONFIRM_FIELD_PASSWORD_MIN_MAX_CHARACTER',
			'WR_CONTACTFORM_CONFIRM_FIELD_EMAIL_CONFIRM',
			'WR_CONTACTFORM_CONFIRM_FIELD_MIN_NUMBER',
			'WR_CONTACTFORM_CONFIRM_FIELD_MAX_NUMBER',
			...
			'WR_CONTACTFORM_CONFIRM_FIELD_MAX_LENGTH',
			'WR_CONTACTFORM_CONFIRM_FIELD_MIN_LENGTH',
